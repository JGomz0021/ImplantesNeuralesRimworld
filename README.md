...
Las definiciones se revisan estáticamente en el repositorio. Es necesario probar el mod dentro de RimWorld para confirmar carga de Defs, disponibilidad de recetas y balance durante una partida.
